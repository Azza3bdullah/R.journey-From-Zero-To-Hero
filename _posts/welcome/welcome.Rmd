---
title: "Welcome to my R journey From Zero To Hero"
description: |
...
date: 08-23-2022
draft: FALSE
base_url: https://azzaalghamdi.netlify.app/
creative_commons: CC BY
citation_URL: https://azzaalghamdi.netlify.app/
output:
...
[***My R journey From Zero To Hero***]{.underline}
...
-   **Week1**: Introduction to R and Open Science and Project Management 

-   **Week2**: Introduction to R Markdown and Git/GitHub
...
-   **Week6**: Learn How to Join with R Communities ([R-Ladies](https://rladies.org/), [Open Science Community Saudi Arabia](https://osc-ksa.com/), [R-Ladies Saudi Arabia (Dammam)](https://www.meetup.com/rladies-dammam/) - Create your first R package - Reproducibility with renv

The complete course materials/Slides are available in [Zenodo]() and [GitHub](https://github.com/BatoolMM/from-Zero-to-hero-in-r) under CC-BY license.
...
We greatful to [Dr. Batool Almarzouq](https://batool-almarzouq.netlify.app/), your explaination was wonderful throughout the course... I really loved it♥️
